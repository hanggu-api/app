                                                                                        ...
                                                                                        -- Garantir suporte ao ON CONFLICT (profession_id, name)
                                                                                        DO $$
                                                                                        BEGIN
                                                                                            IF NOT EXISTS (
                                                                                                SELECT 1
                                                                                                ...
                                                                                                WHERE n.nspname = 'public'
                                                                                                  AND t.relname = 'task_catalog'
                                                                                                  AND c.conname = 'task_catalog_profession_name_key'
                                                                                            ) THEN
                                                                                                ALTER TABLE public.task_catalog
                                                                                                    ADD CONSTRAINT task_catalog_profession_name_key
