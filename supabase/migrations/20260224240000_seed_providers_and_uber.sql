...
BEGIN
    ...
    IF v_public_user_id IS NULL THEN
        INSERT INTO public.users (supabase_uid, email, full_name, role)
        VALUES (v_supabase_uid, 'test_uber_1@example.com', 'Motorista Uber 1', 'provider')
        ON CONFLICT (email) DO UPDATE SET role = 'provider'
        RETURNING id INTO v_public_user_id;
...
BEGIN
    ...
    IF v_public_user_id IS NULL THEN
        INSERT INTO public.users (supabase_uid, email, full_name, role)
        VALUES (v_supabase_uid, 'test_uber_2@example.com', 'Motorista Uber 2', 'provider')
        ON CONFLICT (email) DO UPDATE SET role = 'provider'
        RETURNING id INTO v_public_user_id;
...
BEGIN
    ...
    IF v_public_user_id IS NULL THEN
        INSERT INTO public.users (supabase_uid, email, full_name, role)
        VALUES (v_supabase_uid, 'test_uber_3@example.com', 'Motorista Uber 3', 'provider')
        ON CONFLICT (email) DO UPDATE SET role = 'provider'
        RETURNING id INTO v_public_user_id;
...
BEGIN
    ...
    IF v_public_user_id IS NULL THEN
        INSERT INTO public.users (supabase_uid, email, full_name, role)
        VALUES (v_supabase_uid, 'test_uber_4@example.com', 'Motorista Uber 4', 'provider')
        ON CONFLICT (email) DO UPDATE SET role = 'provider'
        RETURNING id INTO v_public_user_id;
...
BEGIN
    ...
    IF v_public_user_id IS NULL THEN
        INSERT INTO public.users (supabase_uid, email, full_name, role)
        VALUES (v_supabase_uid, 'test_uber_5@example.com', 'Motorista Uber 5', 'provider')
        ON CONFLICT (email) DO UPDATE SET role = 'provider'
        RETURNING id INTO v_public_user_id;
...
BEGIN
    ...
    IF v_public_user_id IS NULL THEN
        INSERT INTO public.users (supabase_uid, email, full_name, role)
        VALUES (v_supabase_uid, 'test_uber_6@example.com', 'Motorista Uber 6', 'provider')
        ON CONFLICT (email) DO UPDATE SET role = 'provider'
        RETURNING id INTO v_public_user_id;
...
BEGIN
    ...
    IF v_public_user_id IS NULL THEN
        INSERT INTO public.users (supabase_uid, email, full_name, role)
        VALUES (v_supabase_uid, 'test_uber_7@example.com', 'Motorista Uber 7', 'provider')
        ON CONFLICT (email) DO UPDATE SET role = 'provider'
        RETURNING id INTO v_public_user_id;
...
BEGIN
    ...
    IF v_public_user_id IS NULL THEN
        INSERT INTO public.users (supabase_uid, email, full_name, role)
        VALUES (v_supabase_uid, 'test_uber_8@example.com', 'Motorista Uber 8', 'provider')
        ON CONFLICT (email) DO UPDATE SET role = 'provider'
        RETURNING id INTO v_public_user_id;
...
BEGIN
    ...
    IF v_public_user_id IS NULL THEN
        INSERT INTO public.users (supabase_uid, email, full_name, role)
        VALUES (v_supabase_uid, 'test_uber_9@example.com', 'Motorista Uber 9', 'provider')
        ON CONFLICT (email) DO UPDATE SET role = 'provider'
        RETURNING id INTO v_public_user_id;
...
BEGIN
    ...
    IF v_public_user_id IS NULL THEN
        INSERT INTO public.users (supabase_uid, email, full_name, role)
        VALUES (v_supabase_uid, 'test_uber_10@example.com', 'Motorista Uber 10', 'provider')
        ON CONFLICT (email) DO UPDATE SET role = 'provider'
        RETURNING id INTO v_public_user_id;
...
BEGIN
    ...
    IF v_public_user_id IS NULL THEN
        INSERT INTO public.users (supabase_uid, email, full_name, role)
        VALUES (v_supabase_uid, 'test_uber_11@example.com', 'Motorista Uber 11', 'provider')
        ON CONFLICT (email) DO UPDATE SET role = 'provider'
        RETURNING id INTO v_public_user_id;
...
BEGIN
    ...
    IF v_public_user_id IS NULL THEN
        INSERT INTO public.users (supabase_uid, email, full_name, role)
        VALUES (v_supabase_uid, 'test_uber_12@example.com', 'Motorista Uber 12', 'provider')
        ON CONFLICT (email) DO UPDATE SET role = 'provider'
        RETURNING id INTO v_public_user_id;
...
BEGIN
    ...
    IF v_public_user_id IS NULL THEN
        INSERT INTO public.users (supabase_uid, email, full_name, role)
        VALUES (v_supabase_uid, 'test_uber_13@example.com', 'Motorista Uber 13', 'provider')
        ON CONFLICT (email) DO UPDATE SET role = 'provider'
        RETURNING id INTO v_public_user_id;
...
BEGIN
    ...
    IF v_public_user_id IS NULL THEN
        INSERT INTO public.users (supabase_uid, email, full_name, role)
        VALUES (v_supabase_uid, 'test_uber_14@example.com', 'Motorista Uber 14', 'provider')
        ON CONFLICT (email) DO UPDATE SET role = 'provider'
        RETURNING id INTO v_public_user_id;
...
BEGIN
    ...
    IF v_public_user_id IS NULL THEN
        INSERT INTO public.users (supabase_uid, email, full_name, role)
        VALUES (v_supabase_uid, 'test_uber_15@example.com', 'Motorista Uber 15', 'provider')
        ON CONFLICT (email) DO UPDATE SET role = 'provider'
        RETURNING id INTO v_public_user_id;
...
BEGIN
    ...
    IF v_public_user_id IS NULL THEN
        INSERT INTO public.users (supabase_uid, email, full_name, role)
        VALUES (v_supabase_uid, 'test_uber_16@example.com', 'Motorista Uber 16', 'provider')
        ON CONFLICT (email) DO UPDATE SET role = 'provider'
        RETURNING id INTO v_public_user_id;
...
BEGIN
    ...
    IF v_public_user_id IS NULL THEN
        INSERT INTO public.users (supabase_uid, email, full_name, role)
        VALUES (v_supabase_uid, 'test_uber_17@example.com', 'Motorista Uber 17', 'provider')
        ON CONFLICT (email) DO UPDATE SET role = 'provider'
        RETURNING id INTO v_public_user_id;
...
BEGIN
    ...
    IF v_public_user_id IS NULL THEN
        INSERT INTO public.users (supabase_uid, email, full_name, role)
        VALUES (v_supabase_uid, 'test_uber_18@example.com', 'Motorista Uber 18', 'provider')
        ON CONFLICT (email) DO UPDATE SET role = 'provider'
        RETURNING id INTO v_public_user_id;
...
BEGIN
    ...
    IF v_public_user_id IS NULL THEN
        INSERT INTO public.users (supabase_uid, email, full_name, role)
        VALUES (v_supabase_uid, 'test_uber_19@example.com', 'Motorista Uber 19', 'provider')
        ON CONFLICT (email) DO UPDATE SET role = 'provider'
        RETURNING id INTO v_public_user_id;
...
BEGIN
    ...
    IF v_public_user_id IS NULL THEN
        INSERT INTO public.users (supabase_uid, email, full_name, role)
        VALUES (v_supabase_uid, 'test_uber_20@example.com', 'Motorista Uber 20', 'provider')
        ON CONFLICT (email) DO UPDATE SET role = 'provider'
        RETURNING id INTO v_public_user_id;
