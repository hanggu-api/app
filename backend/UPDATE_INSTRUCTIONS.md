# Instruções de Atualização - Integração Google Sheets

Para corrigir o problema de carregamento e o erro de permissão ao criar serviços, atualize o script novamente.

## Passo a Passo

1. Abra sua planilha no Google Sheets.
2. No menu superior, clique em **Extensões** > **Apps Script**.
3. Apague **todo** o código que está lá atualmente.
4. Copie e cole o novo código abaixo:
...
function processForm(data) {
  ...
  if (data.id === "") {
    ...
    // Ordem: Profissao, Nome, Unidade, Preco, Keywords, Ativo
