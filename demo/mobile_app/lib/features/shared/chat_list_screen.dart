            ...
            child: _isLoading
                ? ListView.builder(
                    ...
                    itemBuilder: (_, __) => const Padding(
                      ...
                      child: CardSkeleton(), // height handled internally by card structure if needed, or pass fixed value
                    ),
                  )
                : _services.isEmpty
                    ...
                    : ListView.separated(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return ListTile(
                            ...
                            subtitle: Text(
                              service['description'] ?? 'Serviço #$serviceId',
                              style: TextStyle(color: Colors.grey[600]),
                            ),
                            trailing:
                                const Icon(LucideIcons.chevronRight, size: 20),
                            onTap: () {
                              context.push('/chat', extra: serviceId);
                            },
                          );
                        },
                      ),
